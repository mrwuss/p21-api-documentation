...
**Sharing a section:** on the online [Changelog](https://mrwuss.github.io/p21-api-documentation/html/10-Changelog.html) and [Breaking Changes](https://mrwuss.github.io/p21-api-documentation/html/14-Breaking-Changes.html) pages, hovering a section heading reveals a **Copy HTML** button — handy for quoting a release or a single breaking-change entry in a forum post. It copies that section only, with every link rewritten to an absolute URL so it still resolves once pasted elsewhere.
