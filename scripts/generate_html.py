...
# Published site root. Used to turn the relative links inside a copied section
...
def convert_md_to_html(md_file: Path) -> Path:
    ...
    page_url = f"{SITE_BASE}{'recipes/' if is_recipe else ''}{name}.html"
