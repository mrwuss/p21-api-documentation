...
Cleared issues #103 and #105–#107. Every claim was re-checked against the service definitions before it was written, and the checks turned up three errors in our own docs plus one new 26.1 hazard that no issue had reported.
