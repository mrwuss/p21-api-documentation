...
| Write an **item / customer / supplier note** | [03 § Commands Endpoint](03-Transaction-API.md#request-shape) — one stateless POST · or [04 § Standalone Notepad Windows](04-Interactive-API.md#standalone-notepad-windows-itemcustomersupplier) |
